...
def test_collect_editorial_rows_uses_only_explicit_owner_files_and_emits_user_facing_copy(tmp_path: Path) -> None:
    ...
    expected_rows = [
        ...
        ("app-shell-methodology-section-001-heading", "web/src/lib/config/app.ts", "Schedule A scope"),
        (
            "app-shell-methodology-section-001-paragraph-001",
            "web/src/lib/config/app.ts",
        ...
        (
            "app-shell-methodology-section-001-paragraph-002",
            "web/src/lib/config/app.ts",
        ...
        ("app-shell-methodology-section-002-heading", "web/src/lib/config/app.ts", "Donor grouping"),
        (
            "app-shell-methodology-section-002-paragraph-001",
            "web/src/lib/config/app.ts",
        ...
        ("app-shell-methodology-section-003-heading", "web/src/lib/config/app.ts", "Coverage"),
        (
            "app-shell-methodology-section-003-paragraph-001",
            "web/src/lib/config/app.ts",
        ...
        (
            "app-shell-methodology-section-003-paragraph-002",
            "web/src/lib/config/app.ts",
        ...
        (
            "app-shell-methodology-section-003-link-001-label",
            "web/src/lib/config/app.ts",
            "Coverage",
        ),
        (
            "app-shell-methodology-section-003-link-002-label",
            "web/src/lib/config/app.ts",
            "Data sources",
        ),
        ("app-shell-methodology-section-004-heading", "web/src/lib/config/app.ts", "Freshness"),
        (
            "app-shell-methodology-section-004-paragraph-001",
            "web/src/lib/config/app.ts",
            "Federal refreshes are scheduled weekly.",
        ),
        (
            "app-shell-methodology-section-004-paragraph-002",
            "web/src/lib/config/app.ts",
