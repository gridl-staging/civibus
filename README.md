...
Status, scope, and coverage are maintained in `PROJECT_OVERVIEW.md`,
...
Open and planned work is tracked in a private ledger in the development
repository. Historical roadmap archive: `ROADMAP.md` (private, frozen at the
2026-08-15 ledger cutover). Fresh-laptop setup:
...
3. [`docs/reference/research/coverage-registry.json`](docs/reference/research/coverage-registry.json)
4. [`docs/reference/research/coverage-audit-contract.md`](docs/reference/research/coverage-audit-contract.md)
