<script lang="ts">
  ...
  import { buildCandidacyDetailMetadataFromDetail } from "$lib/civic-detail/presentation";
  ...
  $: routeMetadata = buildCandidacyDetailMetadataFromDetail(data);
...
<DetailPage entityType="candidacy" {data} />
