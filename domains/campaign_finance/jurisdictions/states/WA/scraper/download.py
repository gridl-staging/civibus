"""
Stub summary for /Users/stuart/parallel_development/civibus_dev/MAR18_state_expansion_batch_2/civibus_dev/domains/campaign_finance/jurisdictions/states/WA/scraper/download.py.
"""
...
def build_wa_download_url(data_type: str, *, limit: int | None = None) -> str:
    url = _load_bulk_download_url_for_data_type(data_type)
    if limit is None:
        return url

    separator = "&" if "?" in url else "?"
    return f"{url}{separator}$limit={limit}"
