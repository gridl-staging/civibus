"""
Stub summary for /Users/stuart/parallel_development/civibus_dev/mar26_am_3_new_state_pipeline_builds/civibus_dev/domains/campaign_finance/jurisdictions/states/WI/scraper/download.py.
"""
...
def build_wi_download_url(data_type: str) -> str:
...
def download_wi_csv(data_type: str, dest_dir: Path) -> Path:
    download_url = build_wi_download_url(data_type)
    normalized_data_type = data_type.strip().lower()
    destination_path = dest_dir / f"wi_{normalized_data_type}.csv"
