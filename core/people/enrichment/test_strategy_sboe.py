...
def test_sboe_strategy_extracts_expected_fields() -> None:
    ...
    record, attempt = strategy.fetch(CandidateEnrichmentTarget(canonical_name="Jordan Lee"), missing_fields=("biography", "portrait_image_url"))
...
def test_sboe_strategy_returns_no_data_attempt() -> None:
    ...
    record, attempt = strategy.fetch(CandidateEnrichmentTarget(canonical_name="Missing Person"), missing_fields=("biography",))
